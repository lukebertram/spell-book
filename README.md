...
#### A React/Redux app that allows users to search for D&D5e spell information by spell name, February 26th, 2018

#### By **Luke Bertram** & **Chris Knight Johnson**

## Description

This project uses React and Redux along with the [D&D5eAPI](http://www.dnd5eapi.co) to gather spell information for Dungeons and Dragons, 5th Edition. Users can select spells from the API-provided directory to view spell details and then add those spells to their personal spell book for later quick access.
